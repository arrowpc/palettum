...
fn fs_main(@location(0) uv : vec2<f32>) -> @location(0) vec4<f32> {
    ...
    let pixel_srgb_u8 = vec3<u32>(round(pow(pixel_to_process_linear, vec3<f32>(1.0/2.2)) * 255.0));
    let packed_pixel_srgb = (pixel_srgb_u8.r & 0xFFu) | ((pixel_srgb_u8.g & 0xFFu) << 8u) | ((pixel_srgb_u8.b & 0xFFu) << 16u) | (0xFFu << 24u);
    ...
    let final_rgb_linear = vec3<f32>(srgb_to_linear(r_final_srgb), srgb_to_linear(g_final_srgb), srgb_to_linear(b_final_srgb));
